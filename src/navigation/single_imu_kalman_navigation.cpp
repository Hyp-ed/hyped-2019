...
#include "navigation/single_imu_kalman_navigation.hpp"
...
namespace hyped
{
    namespace navigation
    {
        ...
        int SingleImuKalmanNavigation::navigate(unsigned int nTestQueries, float queryDelay,
                                                int runId, Logger log)
        {
            ...
            for (unsigned int i = 0; i < nTestQueries; ++i) {
                ...
                log.INFO("FILTERED", "a_x:%+6.3f  a_y:%+6.3f  a_z:%+6.3f\tv_x:%+6.3f  v_y:%+6.3f  "
                         "v_z:%+6.3f\tp_x:%+6.3f  p_y:%+6.3f  p_z:%+6.3f\n",
                                x[2][0], x[2][1], x[2][2],
                                x[1][0], x[1][1], x[1][2],
                                x[0][0], x[0][1], x[0][2];
